...
irqreturn_t mt792x_irq_handler(int irq, void *dev_instance)
{
	...
	printk(KERN_INFO "mt792x_dma.c - mt792x_irq_handler - tasklet_schedule(&dev->mt76.irq_tasklet);");
...
{
	printk(KERN_INFO "mt792x_dma.c - mt792x_irq_tasklet(%lu)", data);
...
void mt792x_dma_cleanup(struct mt792x_dev *dev)
{
	...
	mt76_set(dev, MT_WFDMA0_RST,
		 MT_WFDMA0_RST_DMASHDL_ALL_RST |
		 MT_WFDMA0_RST_LOGIC_RST);
	printk(KERN_INFO "mt792x_dma.c - mt792x_dma_cleanup - mt76_dma_cleanup(&dev->mt76);");
