...
static ssize_t mt7902_thermal_temp_show(struct device *dev,
					...
					char *buf)
{
    printk(KERN_INFO "init.c - mt7902_thermal_temp_show");
...
{
    printk(KERN_INFO "init.c - mt7902_thermal_init");
...
{
    printk(KERN_INFO "init.c - mt7902_regd_channel_update");
...
{
    printk(KERN_INFO "init.c - mt7902_regd_update");
	struct mt76_dev *mdev = &dev->mt76;
...
{
    printk(KERN_INFO "init.c - mt7902_regd_notifier");
