...
#define MT7902_BEACON_RATES_TBL		25
...
struct mt7902_uni_beacon_loss_event {
	struct {
		u8 bss_idx;
		u8 pad[3];
	} __packed hdr;
	struct mt7902_beacon_loss_tlv beacon_loss;
} __packed;
...
enum mt7902_rxq_id {
	...
	MT7902_RXQ_BAND1,
	MT7902_RXQ_MCU_WM = 0,
	MT7902_RXQ_MCU_WM2, /* for tx done */
};
...
void mt7902_tx_token_put(struct mt792x_dev *dev);
...
int mt7902_get_txpwr_info(struct mt792x_dev *dev, u8 band_idx,
...
void mt7902_mcu_set_suspend_iter(void *priv, u8 *mac,
				 struct ieee80211_vif *vif);
void mt7902_connac_mcu_set_suspend_iter(void *priv, u8 *mac,
					struct ieee80211_vif *vif);
