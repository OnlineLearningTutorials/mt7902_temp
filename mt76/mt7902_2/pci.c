...
static void mt7902_reg_remap_restore(struct mt792x_dev *dev)
{
	/* remap to ori status */
...
static u32 mt7902_reg_map_l1(struct mt792x_dev *dev, u32 addr)
{
...
static u32 mt7902_reg_map_l2(struct mt792x_dev *dev, u32 addr)
{
...
static int mt7902_pci_suspend(struct device *device)
{
	 ...
	 * power consumption
	 */
	mt7902_mcu_set_deep_sleep(dev, true);
...
restore_napi:
	...
	if (!pm->ds_enable)
		mt7902_mcu_set_deep_sleep(dev, false);
