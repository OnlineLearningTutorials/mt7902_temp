...
static inline struct mt7902_txp *
mt7902_txwi_to_txp(struct mt76_dev *dev, struct mt76_txwi_cache *t)
{
	u8 *txwi;
	...
	return (struct mt7902_txp *)(txwi + MT_TXD_SIZE);
}
