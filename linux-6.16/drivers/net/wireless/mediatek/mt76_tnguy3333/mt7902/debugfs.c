...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_reg_set");
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_reg_get");
	struct mt792x_dev *dev = data;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_fw_debug_set");
	struct mt792x_dev *dev = data;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_fw_debug_get");
	struct mt792x_dev *dev = data;
...
mt7902_seq_puts_array(struct seq_file *file, const char *str,
		      s8 *val, int len)
{
	printk(KERN_DEBUG "debugfs.c - mt7902_seq_puts_array");
	int i;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_txpwr");
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_pm_set");
	struct mt792x_dev *dev = data;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_pm_get");
	struct mt792x_dev *dev = data;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_deep_sleep_set");
	struct mt792x_dev *dev = data;
	struct mt76_connac_pm *pm = &dev->pm;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_deep_sleep_get");
	struct mt792x_dev *dev = data;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902_chip_reset");
	struct mt792x_dev *dev = data;
	int ret = 0;
...
{
	printk(KERN_DEBUG "debugfs.c - mt7902s_sched_quota_read");
	struct mt792x_dev *dev = dev_get_drvdata(s->private);
