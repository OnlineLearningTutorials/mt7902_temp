...
{
	printk(KERN_DEBUG "pci.c - mt7902_pci_get_hif2");
...
{
	printk(KERN_DEBUG "pci.c - mt7902_put_hif2");
	if (!hif)
		return;
...
{
	printk(KERN_DEBUG "pci.c - mt7902_pci_hif2_probe");
	struct mt7902_hif *hif;
...
{
	printk(KERN_DEBUG "pci.c - mt7902_hif_remove");
