...
static void
mt7902_tx_cleanup(struct mt7902_dev *dev)
{
...
static void mt7902_dma_config(struct mt7902_dev *dev)
{
	...
	RXQ_CONFIG(MT_RXQ_EXT, WFDMA0, MT_INT_RX_DONE_BAND1, mt7902_RXQ_BAND1);
	RXQ_CONFIG(MT_RXQ_EXT_WA, WFDMA0, MT_INT_RX_DONE_WA_EXT, mt7902_RXQ_MCU_WA_EXT);
	RXQ_CONFIG(MT_RXQ_MAIN_WA, WFDMA0, MT_INT_RX_DONE_WA_MAIN, mt7902_RXQ_MCU_WA_MAIN);
	RXQ_CONFIG(MT_RXQ_TRI, WFDMA0, MT_INT_RX_DONE_BAND2, mt7902_RXQ_BAND2);
	RXQ_CONFIG(MT_RXQ_TRI_WA, WFDMA0, MT_INT_RX_DONE_WA_TRI, mt7902_RXQ_MCU_WA_TRI);
...
static int mt7902_dma_enable(struct mt7902_dev *dev)
{
	u32 hif1_ofs = 0;
	u32 irq_mask;
...
int mt7902_dma_init(struct mt7902_dev *dev)
{
	...
	netif_tx_napi_add(&dev->mt76.tx_napi_dev, &dev->mt76.tx_napi,
			  mt7902_poll_tx, NAPI_POLL_WEIGHT);
	napi_enable(&dev->mt76.tx_napi);

	mt7902_dma_enable(dev);
